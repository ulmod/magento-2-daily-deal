...
* Ability to create an unlimited number of deals and display in the frontend
...
* Ability to auto search products when creating a deal. 
* Ability to export deals into Excel XML or CSV file from the admin grid;
* Support multistore
* Mobile-friendly


<img src="https://www.ulmod.com/media/ulmod/product_content/ddeals-main-min.png">
